...
namespace VilliInput.Conditions
{
    public class MouseSensorCurrentPositionCondition : LogicCondition
    {
        ...
        protected override Value InternalGetValue()
        {
            ...
            {
                case MouseSensor.HorizontalScrollWheel:
                    return new Value(Enums.ValueType.Int, valueInt: MouseService.CurrentHorizontalScrollWheelValue);
                case MouseSensor.Pointer:
                    return new Value(Enums.ValueType.Int, valuePoint: MouseService.CurrentCursorPosition);
                case MouseSensor.ScrollWheels:
                    return new Value(Enums.ValueType.Int, valuePoint: MouseService.CurrentScrollPositions);
                case MouseSensor.VerticalScrollWheel:
                    return new Value(Enums.ValueType.Int, valueInt: MouseService.CurrentVerticalScrollWheelValue);
            }
