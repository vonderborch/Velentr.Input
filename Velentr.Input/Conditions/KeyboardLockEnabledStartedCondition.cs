...
namespace Velentr.Input.Conditions
{
    ...
    public class KeyboardLockEnabledStartedCondition : KeyboardLockStateCondition
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="KeyboardLockEnabledStartedCondition"/> class.
        /// </summary>
