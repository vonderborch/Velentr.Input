...
namespace Velentr.Input.Conditions
{
    ...
    public class GamePadButtonPressStartedCondition : GamePadButtonCondition
    {
        ...
        {
            return Manager.GamePad.WasButtonReleased(Button, playerIndex);
        }
