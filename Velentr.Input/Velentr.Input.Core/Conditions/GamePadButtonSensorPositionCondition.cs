        ...
        protected override Value InternalGetValue()
        {
            switch (Sensor)
            {
                ...
                case GamePadSensor.RightStick:
                    return new Value(ValueType.Vector2, valueVector2: Manager.GamePad.GetStickPosition(Sensor, PlayerIndex, InputMode, SensorValueMode));
                case GamePadSensor.LeftTrigger:
                case GamePadSensor.RightTrigger:
                    return new Value(ValueType.Float, valueFloat: Manager.GamePad.GetTriggerPosition(Sensor, PlayerIndex, InputMode, SensorValueMode));
            }
