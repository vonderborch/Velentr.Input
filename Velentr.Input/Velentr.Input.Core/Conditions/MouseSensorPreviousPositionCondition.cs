...
namespace Velentr.Input.Conditions
{
    ...
    public class MouseSensorPreviousPositionCondition : LogicCondition
    {
        ...
        protected override Value InternalGetValue()
        {
            ...
            {
                case MouseSensor.HorizontalScrollWheel:
                    return new Value(ValueType.Int, valueInt: MouseService.PreviousHorizontalScrollWheelValue);
                case MouseSensor.Pointer:
                    return new Value(ValueType.Int, valuePoint: MouseService.PreviousCursorPosition);
                case MouseSensor.ScrollWheels:
                    return new Value(ValueType.Int, valuePoint: MouseService.PreviousScrollPositions);
                case MouseSensor.VerticalScrollWheel:
                    return new Value(ValueType.Int, valueInt: MouseService.PreviousVerticalScrollWheelValue);
            }
