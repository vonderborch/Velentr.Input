...
{
    /// <summary>
    /// An input condition that is valid when the Current Position of a Mouse sensor meets a certain condition specified by the logicValue parameter.
    /// </summary>
    ...
    public class MouseSensorCurrentPositionCondition : LogicCondition
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="MouseSensorCurrentPositionCondition"/> class.
        /// </summary>
        ...
        protected override Value InternalGetValue()
        {
            ...
            {
                case MouseSensor.HorizontalScrollWheel:
                    return new Value(ValueType.Int, valueInt: Manager.Mouse.CurrentHorizontalScrollWheelValue);
                case MouseSensor.Pointer:
                    return new Value(ValueType.Int, valuePoint: Manager.Mouse.CurrentCursorPosition);
                case MouseSensor.ScrollWheels:
                    return new Value(ValueType.Int, valuePoint: Manager.Mouse.CurrentScrollPositions);
                case MouseSensor.VerticalScrollWheel:
                    return new Value(ValueType.Int, valueInt: Manager.Mouse.CurrentVerticalScrollWheelValue);
            }
